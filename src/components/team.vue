<template>
  <div id="Team" class="component-item">
    ...
    <pre><code class="language-markup">&lt;!-- Individual profile card HTML Usage --&gt;
    &lt;article class="adx-profile"&gt;
    ...
    <h4 class="adx-markup-label">Grouped Course Profile Block</h4>
    ...
    <pre><code class="language-markup">&lt;!-- Grouped profile list HTML Usage --&gt;
    &lt;article class="adx-profile"&gt;
      &lt;img src="image.png" alt=""&gt;
      &lt;section&gt;
        &lt;h3 class="name"&gt;Christian Surname&lt;/h3&gt;

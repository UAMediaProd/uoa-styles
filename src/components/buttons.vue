<template>
  <div id="Buttons" class="component-item">
    <h3>Buttons</h3>
    <p><em>Note: Canvas automatically strips out
      <code>button</code> elements, but the following styles can be applied to
      <code>a</code> tags to mimic the look and experience.</em></p>
